...
public class ActivityRule<T extends Activity> implements TestRule {
    ...
    /**
     * HttpGet the running instance of the specified activity. This will launch it if it is not already
     * running.
     */
    public final T get() {
        launchActivity();
    ...
    /** HttpGet the {@link Instrumentation} instance for this test. */
